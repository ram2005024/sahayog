...
class IncidentService:
    ...
    async def save_incident_image_medias(
        ...
        image_media_data = self.create_image_media_data(image_media, incident_id)
    ...
    async def save_incident_audio_media(
        ...
        audio_media_data = self.create_audio_media_data(audio_media, incident_id)
    ...
    async def create_image_media_data(
        ...
        for media_data in data:
            ...
            meta_data.append(media_data.meta_data)
