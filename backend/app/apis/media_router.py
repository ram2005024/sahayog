...
from app.schemas.media_schema import IncidentSignatureRequest, SignatureResponse
from app.services.cloudinary_service import CloudinaryService

media_api = APIRouter(prefix="/ap1/v1/incident/media")


@media_api.post("/signatures", response_model=SuccessResponse[SignatureResponse])
